...
public final class DockerExecutor {
    ...
    public interface ExecStep {
        ...
        String execAs(String user);

        String exec(Shell shell, String user);
    ...
    private static class Steps implements CommandStep, ExecStep {
        ...
        @Override
        public String exec() {
            return exec(DEFAULT_SHELL, IMAGE_USER);
        }

        @Override
        public String execAs(String user) {
            return exec(DEFAULT_SHELL, user);
        }
         ...
         */
        @Override
        public String exec(Shell shell, String user) {
            Objects.requireNonNull(shell, "Shell cannot be null");
            ExecConfig execConfig = ExecConfig.builder().user(user).workDir(USER_HOME).command(new String[]{
